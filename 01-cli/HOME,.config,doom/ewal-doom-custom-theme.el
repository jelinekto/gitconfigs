...
(defgroup ewal-doom-custom-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom ewal-doom-custom-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'ewal-doom-custom-theme
  :type 'boolean)

(defcustom ewal-doom-custom-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'ewal-doom-custom-theme
  :type 'boolean)

(defcustom ewal-doom-custom-comment-bg ewal-doom-custom-brighter-comments
  "If non-nil, comments will have a subtle, darker background."
  :group 'ewal-doom-custom-theme
  :type 'boolean)

(defcustom ewal-doom-custom-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme ewal-doom-custom
  ...
  ((bg         (ewal-doom-themes-get-color 'background  0))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if ewal-doom-custom-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if ewal-doom-custom-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      magenta)
   (keywords       blue)
   (methods        cyan)
   ...
   (-modeline-bright ewal-doom-custom-brighter-modeline)
   (-modeline-pad
    (when ewal-doom-custom-padded-modeline
      (if (integerp ewal-doom-custom-padded-modeline) ewal-doom-custom-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if ewal-doom-custom-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
(provide-theme 'ewal-doom-custom)

;;; ewal-doom-custom-theme.el ends here
